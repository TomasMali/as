  ...
  <div class="q-pa-md row items-start q-gutter-md q-mt-md">
    <q-card bordered class="my-card shadow-10">
      ...
      <q-card-section class="q-pt-none">
        Scegliere 5 librerie che usi più frequentemente in modo da permettere una ricerca
        più veloce.
      </q-card-section>
...
const setPrefs = async () => {
  ...
  if (pref.getUserPrefAsObj.length) {
    ...
    model2.value =
      pref.getUserPrefAsObj[1] != undefined ? pref.getUserPrefAsObj[1].value : "";
    model3.value =
      pref.getUserPrefAsObj[2] != undefined ? pref.getUserPrefAsObj[2].value : "";
    model4.value =
      pref.getUserPrefAsObj[3] != undefined ? pref.getUserPrefAsObj[3].value : "";
    model5.value =
      pref.getUserPrefAsObj[4] != undefined ? pref.getUserPrefAsObj[4].value : "";
  }
};
